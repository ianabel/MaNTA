...
def main():
    ...
    print("   *restart* file carries and, when nAux > 0, the aux variables:")
    print("   a restart round trip degrades from 1.9e-6 to 8.6e-4, and the")
    print("   AuxVarTest regression case drifts 1.0% past its 0.84% tolerance.")
    print("   That is why the key is off by default. See docs/running.rst.")
    print()
