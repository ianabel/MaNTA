...
Real ThreeVarMirror::Flux(Index i, RealVector u, RealVector q, Position x, Time t, std::vector<Position> *ExtraValues)
{
    switch (Channel(i))
    {
...
Real ThreeVarMirror::Source(Index i, RealVector u, RealVector q, RealVector sigma, Position x, Time t, std::vector<Position> *ExtraValues)
{
    switch (Channel(i))
    {
    case Channel::Density:
