...
Real CylPlasma::Flux(Index i, RealVector u, RealVector q, Position x, Time t, std::vector<Position> *ExtraValues)
{
...
Real CylPlasma::Source(Index i, RealVector u, RealVector q, RealVector sigma, Position x, Time t, std::vector<Position> *ExtraValues)
{
	Channel c = static_cast<Channel>(i);
	switch (c)
	{
