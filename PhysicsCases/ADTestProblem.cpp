...
Real ADTestProblem::Flux(Index i, RealVector u, RealVector q, Position x, Time t, std::vector<Position> *ExtraValues)
{
	return (a / pow(u(0), 1.5)) * q(0);
}

Real ADTestProblem::Source(Index i, RealVector u, RealVector q, RealVector sigma, Position x, Time t, std::vector<Position> *ExtraValues)
{
