#ifndef SCALARTESTLD4_HPP
#define SCALARTESTLD4_HPP
...
class ScalarTestLD4 : public TransportSystem
{
public:
	...
	explicit ScalarTestLD4(toml::value const &config, Grid const &);
...
private:
	...
	// Without this (and the implementation line in ScalarTestLD4.cpp)
	// ManTA won't know how to relate the string 'ScalarTestLD4' to the class.
	REGISTER_PHYSICS_HEADER(ScalarTestLD4)
};
