#ifndef MIRRORPLASMA_DEBUG
#define MIRRORPLASMA_DEBUG
...
class CurvedFieldPlasmaDebug : public AutodiffTransportSystem
{
public:
    CurvedFieldPlasmaDebug(toml::value const &config, Grid const &grid);
    virtual ~CurvedFieldPlasmaDebug() { delete B; };
...
private:
    ...
    REGISTER_PHYSICS_HEADER(CurvedFieldPlasmaDebug)
};
