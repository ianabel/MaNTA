#ifndef MIRRORPLASMALOGDENSITY
#define MIRRORPLASMALOGDENSITY
...
class MirrorPlasmaLogDensity : public AutodiffTransportSystem
{
public:
    MirrorPlasmaLogDensity(toml::value const &config, Grid const &grid);
    virtual ~MirrorPlasmaLogDensity() { delete B; };
...
private:
    ...
    REGISTER_PHYSICS_HEADER(MirrorPlasmaLogDensity)
};
