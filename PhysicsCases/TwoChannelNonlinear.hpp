#ifndef ADJOINTPOSTER_HPP
#define ADJOINTPOSTER_HPP

#include "PhysicsCases.hpp"

class TwoChannelNonlinear : public TransportSystem
{
public:
	...
	explicit TwoChannelNonlinear(toml::value const &config, Grid const & );
...
private:
	...
	// Without this (and the implementation line in TwoChannelNonlinear.cpp)
	// ManTA won't know how to relate the string 'TwoChannelNonlinear' to the class.
	REGISTER_PHYSICS_HEADER(TwoChannelNonlinear)
};

#endif // ADJOINTPOSTER_HPP
