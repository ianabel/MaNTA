...
public:
	...
	void addDelqSourceFunc(int vIndex, std::function<double (double, DGApprox, DGApprox)> func){delqSourceFuncs[vIndex] = func;}
	void addDeluSourceFunc(int vIndex,  std::function<double (double, DGApprox, DGApprox)> func){deluSourceFuncs[vIndex] = func;}
	...
	std::vector<std::function<double (double, DGApprox, DGApprox)>> delqSourceFuncs, deluSourceFuncs;
};
