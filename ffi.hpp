...
static ffi::Error get_solution_ffi_impl_cuda(cudaStream_t stream, PyRunner *runner, ffi::Buffer<i_dtype_cuda> var, std::optional<ffi::BufferR1<fp_dtype_cuda>> points, ffi::Result<ffi::BufferR1<fp_dtype_cuda>> out)
{
