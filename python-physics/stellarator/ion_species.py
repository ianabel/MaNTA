...
import yancc.species as species
...
class _IonSpecies(eqx.Module):
    mass: Float
    charge: Float
    yancc_species: species.Species

    def __init__(self, yancc_species):
        self.yancc_species = yancc_species
        self.mass = yancc_species.mass
        self.charge = yancc_species.charge
...
class Hydrogen(_IonSpecies):
    def __init__(self):
        super().__init__(species.Hydrogen)
...
class Deuterium(_IonSpecies):
    def __init__(self):
        super().__init__(species.Deuterium)
...
class DeuteriumTritium(_IonSpecies):
    def __init__(self):
        return super().__init__(species.Species(2.5,1))
