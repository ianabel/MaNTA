...
SOURCES = Config.cpp ConfigSchema.cpp SolverConfig.cpp SystemSolver.cpp SunLinSolWrapper.cpp SunMatrixWrapper.cpp ErrorChecker.cpp Solver.cpp Matrices.cpp DGStatic.cpp PhysicsCases.cpp NetCDFIO.cpp AdjointVectors.cpp Postprocessing.cpp AlgebraicDerivatives.cpp SteadyState.cpp SmoothnessSensor.cpp
